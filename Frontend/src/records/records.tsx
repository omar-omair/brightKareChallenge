...
export default function Records(): ReactElement {
    ...
    return (
        <>
            <div className={`w-mobile sm:max-w-lg lg:max-w-full ml-2 grid grid-cols-2 min-w-32 gap-5 lg:flex overflow-hidden lg:w-full lg:items-center lg:justify-start`}>
