    ...
    return (
        <header className='flex justify-end space-x-3 p-2 items-center mb-5'>
            ...
            <div className='flex relative py-1'>
                ...
                <div className='bg-blue-900 absolute -top-1 left-4 lg:left-5 lg:top-0 rounded-full w-4 h-4 px-1 py-2 text-xs shadow-md text-white flex justify-center items-center'>{notifications}</div>
            </div>
